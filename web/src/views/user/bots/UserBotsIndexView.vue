...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app3403.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url:"https://app3403.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    name: bot_add.name,
        ...
        const remove_bot = (bot_id) => {
            $.ajax({
                url:"https://app3403.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot_id,
                },
        ...
        const update_bot = (bot) => {
            bot.error_message = "" ;
            $.ajax({
                url:"https://app3403.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    name: bot.name,
